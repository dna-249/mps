...
<head>
    ...
    <title>Login | MPS Media Poetry Challenge 2026</title>
    ...
    <div class="min-h-screen flex flex-col justify-center py-16 px-6">
        <div class="max-w-md w-full mx-auto">
            ...
            <div class="bg-white p-8 md:p-10 rounded-2xl shadow-2xl border-t-8 border-purple-900">
                <h1 class="text-3xl font-black text-purple-900 mb-2 text-center tracking-tight">Welcome Back</h1>
                <p class="text-gray-600 mb-8 text-sm text-center">Sign in to manage your application for the 2026 Arewa Edition.</p>
                ...
                <div class="mt-8 border-t pt-6 text-center text-sm text-gray-500">
                    ...
                    <a href="{{ route('register') }}" class="text-pink-600 font-bold hover:underline">Register here</a>
                </div>
            </div>
